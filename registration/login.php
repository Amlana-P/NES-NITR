            ...
            <div class="card card-3">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="login.php">
                        ...
                        <div class="p-t-10">
                            <button class="btn btn--pill btn--green" type="submit" name="login_user">Sign in</button>
                        </div>
                    </form>
                    <div class="p-t-10" style="margin-bottom: 12px;">
                        <button class="btn btn--pill btn--green" onclick="window.location.href = './register.php';">Sign up</button>
                    </div>
                    <div>
